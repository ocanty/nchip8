...
void gui::update_log_window()
{
    ...
    int height = log_window_h - 2; // height without borders
    int y = log_window_h - 1;      // initial y coordinate (from bottom) (skipping bottom border)
    ...
    {
        ::mvwprintw(m_log_window.get(), y, 2, (*it).c_str());
        y--;
    }
